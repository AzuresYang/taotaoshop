...
public class FtpHelper {
     ...
     * 服务器地址
     */
    private String hostName = "193.112.68.221";
     ...
     * 密码.
     */
    private String password = "ftpuser2018";
     ...
     * FTP根目录.
     */
    public static final String REMOTE_PATH = "/home/ftpuser";
     ...
     */
    public FtpHelper(String host, String user, String pass,int port) {
        this.hostName = host;
        this.userName = user;
        this.password = pass;
    ...
    public FtpHelper() {
        ...
        this.ftpClient = new FTPClient();
        //如果不调用这个方法设置端口，则是使用默认端口21
        this.ftpClient.setDefaultPort(FTP_PORT);
    }
